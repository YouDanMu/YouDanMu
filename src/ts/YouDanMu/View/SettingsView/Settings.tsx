        ...
        return (
            <div className="ydm-settings-container">
                <div className="ydm-settings-title-bar">
                    ...
                    <div className="ydm-settings-close" onClick={() => props.ydm.settingsView.hide()} dangerouslySetInnerHTML={{__html: `
                    ...
                    <div className="ydm-settings-part">
                        ...
                        <div className="ydm-settings-controls">
                            ...
                            <div className="ydm-radio-group">
                                ...
                                <label for="ydm-settings-post-position-top" className="ydm-icon" title="__MSG_DanmakuPositionTop__" dangerouslySetInnerHTML={{__html: `
                                    <svg viewBox="0 0 15 15"><rect width="15" height="3" /><polygon points="8 3 12 9 9 8 8 15 8 15 7 8 4 9 8 3" /></svg>
                                `}}>
                                </label>
                                <input id="ydm-settings-post-position-bottom" name="ydm-settings-post-position" type="radio" />
                                <label for="ydm-settings-post-position-bottom" className="ydm-icon" title="__MSG_DanmakuPositionBottom__" dangerouslySetInnerHTML={{__html: `
                                    <svg viewBox="0 0 15 15"><rect y="12" width="15" height="3" /><polygon points="7 12 3 6 6 7 7 0 7 0 8 7 11 6 7 12" /></svg>
                                `}}>
                                </label>
                                <input id="ydm-settings-post-position-roll" name="ydm-settings-post-position" type="radio" checked />
                                <label for="ydm-settings-post-position-roll" className="ydm-icon" title="__MSG_DanmakuPositionMarquee__" dangerouslySetInnerHTML={{__html: `
                                    <svg viewBox="0 0 15 15"><rect width="15" height="3" /><rect y="5" width="8" height="3" /><rect x="11" y="5" width="4" height="3" /><polygon points="0 11 5 8 4 11 15 11 15 12 4 12 5 15 0 11" /></svg>
                                `}}>
                                </label>
                            </div>
                            <div className="ydm-radio-group">
